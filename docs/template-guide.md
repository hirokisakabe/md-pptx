...
`md-pptx inspect` コマンドで、テンプレート PPTX のレイアウトとプレースホルダ情報を確認できます。

```bash
md-pptx inspect ./templates/company.pptx
```

テンプレートに含まれるレイアウト名とプレースホルダの type・idx が一覧表示されます。新しいテンプレートを作成した際は、このコマンドで md-pptx が正しく認識しているかを確認してください。
